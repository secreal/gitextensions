...
public static class AppColorDefaults
{
    ...
    private static readonly Dictionary<AppColor, Color> _values =
        new()
        {
            ...
            { AppColor.RevisionGridRelativeSelectedText, Color.Empty },
            { AppColor.RevisionGridNonRelativeText, Color.Empty },
            { AppColor.RevisionGridNonRelativeSelectedText, Color.Empty },
            ...
            { AppColor.ChecklistStatusSuccess, Color.FromArgb(128, 255, 128) },
            { AppColor.ChecklistStatusWarning, Color.FromArgb(255, 255, 128) },
            { AppColor.ChecklistStatusError, Color.FromArgb(255, 128, 128) },
            { AppColor.ResetSoftBackground, Color.FromArgb(128, 255, 128) },
            { AppColor.ResetMixedBackground, Color.FromArgb(255, 255, 128) },
            { AppColor.ResetHardBackground, Color.FromArgb(255, 128, 128) },
            { AppColor.SummaryTagBackground, Color.LightSteelBlue },
            { AppColor.SummaryBranchBackground, Color.LightSalmon },
            { AppColor.InteractiveActionBackground, Color.LightSkyBlue },
            { AppColor.InteractiveActionErrorBackground, Color.Orange },
