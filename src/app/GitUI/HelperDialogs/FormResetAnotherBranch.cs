...
public partial class FormResetAnotherBranch : GitModuleForm
{
    ...
    private void Validate(object sender, EventArgs e)
    {
        ...
        Branches.BackColor = gitRefToReset is null && ActiveControl != Branches ? AppColor.ChecklistStatusError.GetThemeColor(Color.LightCoral.AdaptBackColor()) : SystemColors.Window;
        ...
        ThreadHelper.FileAndForget(async () =>
        {
            ...
            {
                Ok.BackColor = AppColor.ChecklistStatusError.GetThemeColor(Color.LightCoral.AdaptBackColor());
            }
        });
    }
}
