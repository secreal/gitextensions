...
public partial class ChecklistSettingsPage : SettingsPageWithHeader
{
    ...
    {
        settingButton.BackColor = AppColor.ChecklistStatusSuccess.GetThemeColor();
    ...
    {
        settingButton.BackColor = AppColor.ChecklistStatusError.GetThemeColor();
        settingButton.ForeColor = ColorHelper.GetForeColorForBackColor(settingButton.BackColor);
        settingButton.Text = text;
    ...
    {
        settingButton.BackColor = AppColor.ChecklistStatusWarning.GetThemeColor();
        settingButton.ForeColor = ColorHelper.GetForeColorForBackColor(settingButton.BackColor);
        settingButton.Text = text;
        settingFixButton.Visible = true;
    }
